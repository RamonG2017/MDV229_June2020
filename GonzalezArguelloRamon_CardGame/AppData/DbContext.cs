...
namespace CardGame.AppData
{
  ...
  public class DbContext
  {
    ...
    /// </summary>
    /// <returns></returns>
    public IEnumerable<RestaurantReviewer> Reviewers()
    {
      return Select(AppQueries.QUERY_RESTAURANT_REVIEWER,
        reader =>
        {
          var result = new List<RestaurantReviewer>();
          while (reader.Read())
            result.Add(new RestaurantReviewer
            {
              Id = Convert.ToInt32(reader["id"].ToString()),
