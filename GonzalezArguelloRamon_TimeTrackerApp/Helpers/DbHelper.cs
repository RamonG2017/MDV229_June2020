...
namespace TimeTrackerApp.Helpers
{
    ...
    ///     <returns>DbHelper Data Context</returns>
    /// </summary>
    public class DbHelper
    {
        ...
        /// <returns>Number of modified rows and -1 if fail</returns>
        ...
        /// </summary>
        /// <param name="query">SQL Query</param>
        /// <returns>MySQL Reader Cursor</returns>
        ...
        public List<User> Users()
        {
            ...
            var query = "SELECT user_id, user_password, user_firstname, user_lastname FROM time_tracker_users";
        ...
        /// <summary>
        /// Get all categories of activities available in table categories_of_activities
        /// </summary>
        /// <returns>Categories of Activities List</returns>
        public List<CategoryOfActivity> Categories()
        {
            var categories = new List<CategoryOfActivity>();
            var query = "SELECT activity_category_id, category_description FROM activity_categories";
            var result = ExecuteReader(query);
            while (result.Read())
        ...
        public List<CalendarDate> CalendarDates()
        {
            ...
            var query = "SELECT calendar_date_id, calendar_date from tracked_calendar_dates";
            var result = ExecuteReader(query);
            while (result.Read())
        ...
        public List<TimeOfActivity> TimeOfActivities()
        {
            ...
            var query = "SELECT activity_times_id, time_spent_on_activity FROM activity_times";
            var result = ExecuteReader(query);
            while (result.Read())
        ...
        public List<DescriptionOfActivity> Activities()
        {
            ...
            var query = "SELECT activity_description_id, activity_description FROM activity_descriptions";
            var result = ExecuteReader(query);
            while(result.Read())
